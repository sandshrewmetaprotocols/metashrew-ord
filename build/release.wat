(module
 ...
 (data $55 (i32.const 7196) "|")
 (data $55.1 (i32.const 7208) "\02\00\00\00f\00\00\00~\00l\00i\00b\00/\00m\00e\00t\00a\00s\00h\00r\00e\00w\00-\00a\00s\00/\00a\00s\00s\00e\00m\00b\00l\00y\00/\00b\00l\00o\00c\00k\00d\00a\00t\00a\00/\00i\00n\00s\00c\00r\00i\00p\00t\00i\00o\00n\00.\00t\00s")
 (data $56 (i32.const 7324) "\1c")
 (data $56.1 (i32.const 7336) "2\00\00\00\08\00\00\00\06")
 (data $57 (i32.const 7356) "<")
 (data $57.1 (i32.const 7368) "\02\00\00\00 \00\00\00~\00l\00i\00b\00/\00d\00a\00t\00a\00v\00i\00e\00w\00.\00t\00s")
 (data $58 (i32.const 7420) "<")
 (data $58.1 (i32.const 7432) "\02\00\00\00\"\00\00\00D\00e\00c\00o\00d\00e\00r\00 \00p\00o\00s\00i\00t\00i\00o\00n\00 ")
 (data $59 (i32.const 7484) "<")
 (data $59.1 (i32.const 7496) "\02\00\00\00\"\00\00\00 \00i\00s\00 \00o\00u\00t\00 \00o\00f\00 \00r\00a\00n\00g\00e\00!")
 (data $60 (i32.const 7548) "\1c\00\00\00\03\00\00\00\00\00\00\00:\00\00\00\0c\00\00\00\10\1d\00\00\00\00\00\00P\1d")
 (data $61 (i32.const 7580) "<")
 (data $61.1 (i32.const 7592) "\02\00\00\00(\00\00\00a\00s\00s\00e\00m\00b\00l\00y\00/\00p\00r\00o\00t\00o\00b\00u\00f\00.\00t\00s")
 (data $62 (i32.const 7644) "\1c")
 (data $62.1 (i32.const 7656) "?\00\00\00\08\00\00\00\07")
 (data $63 (i32.const 7676) "\1c")
 (data $63.1 (i32.const 7688) "\02\00\00\00\02\00\00\00.")
 (data $64 (i32.const 7708) "\1c")
 (data $64.1 (i32.const 7720) "D\00\00\00\08\00\00\00\08")
 (data $65 (i32.const 7740) "\1c")
 (data $65.1 (i32.const 7752) "E\00\00\00\08\00\00\00\t")
 (data $66 (i32.const 7772) "\1c")
 (data $66.1 (i32.const 7784) "F\00\00\00\08\00\00\00\n")
 (data $67 (i32.const 7804) "\1c")
 (data $67.1 (i32.const 7816) "F\00\00\00\08\00\00\00\0b")
  ...
  loop $while-continue|0
   ...
   if
    ...
    if (result i32)
     ...
     block $__inlined_func$~lib/string/String.__eq$1342 (result i32)
      i32.const 1
      local.get $5
      i32.load
      local.tee $2
      local.get $1
      i32.eq
      br_if $__inlined_func$~lib/string/String.__eq$1342
      drop
      i32.const 0
      local.get $1
      i32.eqz
   ...
   loop $for-loop|00
    ...
    if
     block $for-break0
      ...
      block $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/isZeroU256$443 (result i32)
       i32.const 0
       local.set $6
       loop $for-loop|001
        local.get $6
        ...
        if
         ...
         i64.const 0
         i64.ne
         br_if $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/isZeroU256$443
         drop
         local.get $6
         i32.const 1
         i32.add
  ...
  loop $for-loop|0
   ...
   if
    ...
    if
     i32.const 0
     local.set $5
     block $__inlined_func$~lib/metashrew-as/assembly/blockdata/transaction/Input#inscription$1214
      local.get $3
      local.get $15
      call $~lib/array/Array<~lib/metashrew-as/assembly/blockdata/transaction/Input>#__get
      i32.load offset=20
      local.tee $10
      i32.eqz
      br_if $__inlined_func$~lib/metashrew-as/assembly/blockdata/transaction/Input#inscription$1214
      i32.const 0
      local.set $11
      block $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness#tapscript$1354
       local.get $10
       i32.load offset=4
       local.tee $8
       i32.load offset=12
       ...
       i32.const 0
       i32.le_s
       br_if $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness#tapscript$1354
       local.get $7
       i32.const 2
       i32.ge_s
       if (result i32)
 ...
 (func $assembly/protobuf/__proto.Decoder#varint (param $0 i32) (result i64)
  ...
  block $folding-inner0
   ...
   if
    ...
    i32.const 7120
    local.set $2
    block $__inlined_func$~lib/util/string/joinStringArray$741
     i32.const 7564
     i32.load
     i32.const 2
     i32.shr_u
     ...
     i32.const 0
     i32.lt_s
     br_if $__inlined_func$~lib/util/string/joinStringArray$741
     local.get $7
     i32.eqz
     if
      i32.const 7568
      ...
      br $__inlined_func$~lib/util/string/joinStringArray$741
     end
     loop $for-loop|0
      local.get $4
      local.get $6
 ...
 (func $assembly/protobuf/__proto.SafeDecoder#skipType (param $0 i32) (param $1 i32)
  ...
  block $break|0
   block $case5|0
    ...
    block $__inlined_func$assembly/protobuf/__proto.SafeDecoder#invalid$12631 (result i32)
     i32.const 1
     local.get $0
     i32.load8_u offset=8
     br_if $__inlined_func$assembly/protobuf/__proto.SafeDecoder#invalid$12631
     drop
     local.get $0
     i32.load offset=4
     i32.const 4096
     ...
     if
      ...
      i32.store8 offset=8
      i32.const 1
      br $__inlined_func$assembly/protobuf/__proto.SafeDecoder#invalid$12631
     end
     i32.const 0
    end
    i32.eqz
 ...
 (func $assembly/protobuf/ordinals.SatRangesRequest.decodeDataView (param $0 i32) (result i32)
  ...
  i32.store
  loop $while-continue|0
   block $__inlined_func$assembly/protobuf/__proto.SafeDecoder#invalid$1253 (result i32)
    i32.const 1
    local.get $1
    i32.load8_u offset=8
    br_if $__inlined_func$assembly/protobuf/__proto.SafeDecoder#invalid$1253
    drop
    local.get $1
    i32.load offset=4
    i32.const 4096
    ...
    if
     ...
     i32.store8 offset=8
     i32.const 1
     br $__inlined_func$assembly/protobuf/__proto.SafeDecoder#invalid$1253
    end
    i32.const 0
   end
   if (result i32)
   ...
   if
    ...
    if
     ...
     local.set $3
     local.get $0
     block $__inlined_func$assembly/protobuf/ordinals.OutPoint.decodeDataView$1365 (result i32)
      local.get $1
      i32.load
      local.tee $2
      i32.load
      ...
      loop $while-continue|01
       block $__inlined_func$assembly/protobuf/__proto.SafeDecoder#invalid$12530 (result i32)
        i32.const 1
        local.get $5
        i32.load8_u offset=8
        br_if $__inlined_func$assembly/protobuf/__proto.SafeDecoder#invalid$12530
        drop
        local.get $5
        i32.load offset=4
        i32.const 4096
        ...
        if
         ...
         i32.store8 offset=8
         i32.const 1
         br $__inlined_func$assembly/protobuf/__proto.SafeDecoder#invalid$12530
        end
        i32.const 0
       end
       if (result i32)
      ...
      br_if $__inlined_func$assembly/protobuf/ordinals.OutPoint.decodeDataView$1365
      drop
      local.get $6
     end
     i32.store
 ...
 (func $~lib/metashrew-as/assembly/blockdata/sat/Sat#epochPosition (param $0 i32) (result i64)
  local.get $0
  i64.load
  block $__inlined_func$~lib/metashrew-as/assembly/blockdata/epoch/Epoch#startingSat$1288 (result i32)
   local.get $0
   ...
   if
    ...
    i32.const 33
    call $~lib/array/Array<~lib/metashrew-as/assembly/blockdata/transaction/Input>#__get
    br $__inlined_func$~lib/metashrew-as/assembly/blockdata/epoch/Epoch#startingSat$1288
   end
   global.get $~lib/metashrew-as/assembly/blockdata/epoch/Epoch.STARTING_SATS
   local.get $0
   i32.load
 ...
 (func $~lib/metashrew-as/assembly/utils/rlp/toRLP (param $0 i32) (result i32)
  ...
  if
   ...
   if
    ...
    block $__inlined_func$~lib/metashrew-as/assembly/utils/rlp/byteLengthForLength$970 (result i32)
     i32.const 4
     local.get $1
     i32.const 24
     i32.shr_s
     br_if $__inlined_func$~lib/metashrew-as/assembly/utils/rlp/byteLengthForLength$970
     drop
     i32.const 3
     local.get $1
     i32.const 16
   ...
   if
    ...
    local.get $1
    block $__inlined_func$~lib/metashrew-as/assembly/utils/rlp/byteLengthForLength$976 (result i32)
     i32.const 4
     local.get $1
     i32.const 24
     i32.shr_s
     br_if $__inlined_func$~lib/metashrew-as/assembly/utils/rlp/byteLengthForLength$976
     drop
     i32.const 3
     local.get $1
     i32.const 16
 ...
 (func $assembly/index/sat (result i32)
  ...
  call $~lib/string/String.__concat
  local.set $3
  block $__inlined_func$~lib/util/number/utoa64$64
   local.get $4
   call $~lib/metashrew-as/assembly/blockdata/sat/Sat#epochPosition
   local.get $4
   call $~lib/metashrew-as/assembly/blockdata/sat/Sat#epoch
   ...
   if
    i32.const 5536
    local.set $2
    br $__inlined_func$~lib/util/number/utoa64$64
   end
   local.get $1
   i64.const 4294967295
   i64.le_u
