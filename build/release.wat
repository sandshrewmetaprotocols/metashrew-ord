(module
  ...
  loop $while-continue|0
   ...
   if
    ...
    if (result i32)
     ...
     block $__inlined_func$~lib/string/String.__eq$948 (result i32)
      i32.const 1
      local.get $5
      i32.load
      local.tee $2
      local.get $1
      i32.eq
      br_if $__inlined_func$~lib/string/String.__eq$948
      drop
      i32.const 0
      local.get $1
      i32.eqz
 ...
 (func $~lib/metashrew-as/assembly/blockdata/inscription/Inscription#constructor (param $0 i32) (result i32)
  ...
  i32.store8 offset=8
  local.get $1
  block $__inlined_func$~lib/metashrew-as/assembly/blockdata/inscription/parseEnvelope$37 (result i32)
   local.get $0
   i32.load
   local.get $0
   i32.load offset=4
   ...
   loop $while-continue|1
    ...
    if
     ...
     if
      ...
      i32.sub
      call $~lib/metashrew-as/assembly/utils/box/Box#constructor
      br $__inlined_func$~lib/metashrew-as/assembly/blockdata/inscription/parseEnvelope$37
     end
     local.get $2
     call $~lib/metashrew-as/assembly/utils/utils/parsePushOp
     drop
 ...
 (func $assembly/index/Index.indexTransactionInscriptions (param $0 i32) (param $1 i32) (param $2 i32)
  ...
  loop $for-loop|0
   ...
   if
    i32.const 0
    local.set $5
    block $__inlined_func$~lib/metashrew-as/assembly/blockdata/transaction/Input#inscription$878
     local.get $3
     local.get $14
     call $~lib/array/Array<~lib/metashrew-as/assembly/blockdata/transaction/Input>#__get
     i32.load offset=20
     local.tee $10
     i32.eqz
     br_if $__inlined_func$~lib/metashrew-as/assembly/blockdata/transaction/Input#inscription$878
     i32.const 0
     local.set $11
     block $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness#tapscript$963
      local.get $10
      i32.load offset=4
      local.tee $8
      i32.load offset=12
      ...
      i32.const 0
      i32.le_s
      br_if $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness#tapscript$963
      local.get $7
      i32.const 2
      i32.ge_s
      if (result i32)
     ...
     local.get $11
     if (result i32)
      block $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness.isInscribed$45 (result i32)
       local.get $11
       i32.load
       local.get $11
       i32.load offset=4
       ...
       i32.eqz
       br_if $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness.isInscribed$45
       drop
       local.get $7
       call $~lib/metashrew-as/assembly/utils/utils/parsePushOp
       i32.load
    ...
    if
     ...
     loop $for-loop|1
      ...
      if
       ...
       call $~lib/metashrew-as/assembly/indexer/tables/IndexPointer#getValue<u64>
       local.set $9
       block $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/BST<u64>#seekLower$46 (result i64)
        global.get $assembly/tables/SAT_TO_OUTPOINT
        local.set $8
        i32.const 8
        call $~lib/arraybuffer/ArrayBuffer#constructor
        ...
        loop $do-loop|0
         ...
         if
          ...
          if
           ...
           br $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/BST<u64>#seekLower$46
          end
         end
         local.get $3
         local.tee $5
   ...
   if
    ...
    loop $for-loop|025
     ...
     if
      ...
      global.get $assembly/tables/STARTING_SAT
      call $~lib/metashrew-as/assembly/indexer/tables/IndexPointer#getValue<u64>
      block $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/BST<u64>#seekGreater$47 (result i64)
       i32.const 8
       call $~lib/arraybuffer/ArrayBuffer#constructor
       local.tee $4
       local.get $7
       ...
       loop $do-loop|0
        ...
        if
         ...
         if
          ...
          i32.const 1
          call $~lib/metashrew-as/assembly/indexer/bst/BST<u64>#_findBoundaryFromPartial
          br $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/BST<u64>#seekGreater$47
         end
        end
        local.get $2
        local.tee $4
 ...
 (func $~lib/metashrew-as/assembly/utils/rlp/toRLP (param $0 i32) (result i32)
  ...
  if
   ...
   if
    ...
    block $__inlined_func$~lib/metashrew-as/assembly/utils/rlp/byteLengthForLength$626 (result i32)
     i32.const 4
     local.get $1
     i32.const 24
     i32.shr_s
     br_if $__inlined_func$~lib/metashrew-as/assembly/utils/rlp/byteLengthForLength$626
     drop
     i32.const 3
     local.get $1
     i32.const 16
   ...
   if
    ...
    local.get $1
    block $__inlined_func$~lib/metashrew-as/assembly/utils/rlp/byteLengthForLength$632 (result i32)
     i32.const 4
     local.get $1
     i32.const 24
     i32.shr_s
     br_if $__inlined_func$~lib/metashrew-as/assembly/utils/rlp/byteLengthForLength$632
     drop
     i32.const 3
     local.get $1
     i32.const 16
 ...
 (func $~lib/metashrew-as/assembly/blockdata/sat/Sat#epochPosition (param $0 i32) (result i64)
  local.get $0
  i64.load
  block $__inlined_func$~lib/metashrew-as/assembly/blockdata/epoch/Epoch#startingSat$910 (result i32)
   local.get $0
   ...
   if
    ...
    i32.const 33
    call $~lib/array/Array<~lib/metashrew-as/assembly/blockdata/transaction/Input>#__get
    br $__inlined_func$~lib/metashrew-as/assembly/blockdata/epoch/Epoch#startingSat$910
   end
   global.get $~lib/metashrew-as/assembly/blockdata/epoch/Epoch.STARTING_SATS
   local.get $0
   i32.load
