(module
 ...
 (data $57.1 (i32.const 7368) "\02\00\00\00\02\00\00\00.")
 (data $58 (i32.const 7388) "\1c")
 (data $58.1 (i32.const 7400) "8\00\00\00\08\00\00\00\07")
 (data $59 (i32.const 7420) "\1c")
 (data $59.1 (i32.const 7432) "9\00\00\00\08\00\00\00\08")
 (data $60 (i32.const 7452) "\1c")
 (data $60.1 (i32.const 7464) ":\00\00\00\08\00\00\00\t")
  ...
  loop $while-continue|0
   ...
   if
    ...
    if (result i32)
     ...
     block $__inlined_func$~lib/string/String.__eq$1088 (result i32)
      i32.const 1
      local.get $5
      i32.load
      local.tee $2
      local.get $1
      i32.eq
      br_if $__inlined_func$~lib/string/String.__eq$1088
      drop
      i32.const 0
      local.get $1
      i32.eqz
 ...
 (func $~lib/metashrew-as/assembly/blockdata/inscription/Inscription#constructor (param $0 i32) (result i32)
  ...
  i32.store8 offset=8
  local.get $2
  block $__inlined_func$~lib/metashrew-as/assembly/blockdata/inscription/parseEnvelope$43 (result i32)
   local.get $0
   i32.load
   local.get $0
   i32.load offset=4
   ...
   loop $while-continue|1
    ...
    if
     ...
     if
      ...
      i32.sub
      call $~lib/metashrew-as/assembly/utils/box/Box#constructor
      br $__inlined_func$~lib/metashrew-as/assembly/blockdata/inscription/parseEnvelope$43
     end
     local.get $1
     call $~lib/metashrew-as/assembly/utils/utils/parsePushOp
     drop
  ...
  loop $for-loop|0
   ...
   if
    ...
    if
     i32.const 0
     local.set $5
     block $__inlined_func$~lib/metashrew-as/assembly/blockdata/transaction/Input#inscription$1000
      local.get $3
      local.get $15
      call $~lib/array/Array<~lib/metashrew-as/assembly/blockdata/transaction/Input>#__get
      i32.load offset=20
      local.tee $10
      i32.eqz
      br_if $__inlined_func$~lib/metashrew-as/assembly/blockdata/transaction/Input#inscription$1000
      i32.const 0
      local.set $11
      block $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness#tapscript$1102
       local.get $10
       i32.load offset=4
       local.tee $8
       i32.load offset=12
       ...
       i32.const 0
       i32.le_s
       br_if $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness#tapscript$1102
       local.get $7
       i32.const 2
       i32.ge_s
       if (result i32)
      ...
      local.get $11
      if (result i32)
       block $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness.isInscribed$56 (result i32)
        local.get $11
        i32.load
        local.get $11
        i32.load offset=4
        ...
        i32.eqz
        br_if $__inlined_func$~lib/metashrew-as/assembly/blockdata/witness/Witness.isInscribed$56
        drop
        local.get $7
        call $~lib/metashrew-as/assembly/utils/utils/parsePushOp
        i32.load
     ...
     if
      ...
      loop $for-loop|1
       ...
       if
        ...
        call $~lib/metashrew-as/assembly/indexer/tables/IndexPointer#getValue<u64>
        local.set $9
        block $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/BST<u64>#seekLower$57 (result i64)
         global.get $assembly/tables/SAT_TO_OUTPOINT
         local.set $8
         i32.const 8
         call $~lib/arraybuffer/ArrayBuffer#constructor
         ...
         loop $do-loop|0
          ...
          if
           ...
           if
            ...
            br $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/BST<u64>#seekLower$57
           end
          end
          local.get $3
          local.tee $5
   ...
   if
    ...
    loop $for-loop|025
     ...
     if
      ...
      call $~lib/array/Array<u64>#__get
      local.set $8
      block $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/BST<u64>#seekGreater$58 (result i64)
       i32.const 8
       call $~lib/arraybuffer/ArrayBuffer#constructor
       local.tee $4
       local.get $8
       ...
       loop $do-loop|0
        ...
        if
         ...
         if
          ...
          i32.const 1
          call $~lib/metashrew-as/assembly/indexer/bst/BST<u64>#_findBoundaryFromPartial
          br $__inlined_func$~lib/metashrew-as/assembly/indexer/bst/BST<u64>#seekGreater$58
         end
        end
        local.get $2
        local.tee $4
 ...
 (func $~lib/metashrew-as/assembly/blockdata/sat/Sat#epochPosition (param $0 i32) (result i64)
  local.get $0
  i64.load
  block $__inlined_func$~lib/metashrew-as/assembly/blockdata/epoch/Epoch#startingSat$1036 (result i32)
   local.get $0
   ...
   if
    ...
    i32.const 33
    call $~lib/array/Array<~lib/metashrew-as/assembly/blockdata/transaction/Input>#__get
    br $__inlined_func$~lib/metashrew-as/assembly/blockdata/epoch/Epoch#startingSat$1036
   end
   global.get $~lib/metashrew-as/assembly/blockdata/epoch/Epoch.STARTING_SATS
   local.get $0
   i32.load
 ...
 (func $assembly/index/sat (result i32)
  ...
  call $~lib/string/String.__concat
  local.set $3
  block $__inlined_func$~lib/util/number/utoa64$61
   local.get $4
   call $~lib/metashrew-as/assembly/blockdata/sat/Sat#epochPosition
   local.get $4
   call $~lib/metashrew-as/assembly/blockdata/sat/Sat#epoch
   ...
   if
    i32.const 5536
    local.set $2
    br $__inlined_func$~lib/util/number/utoa64$61
   end
   local.get $1
   i64.const 4294967295
   i64.le_u
